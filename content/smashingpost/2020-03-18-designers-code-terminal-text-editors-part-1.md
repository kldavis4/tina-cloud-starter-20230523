...
Here we have a list of names that we need to convert into email addresses &mdash; we’d also like to make them all lowercase and then sort them alphabetically. This can be done with a few keystrokes.
